...
| Qwen-Image-2.1 | `qwen_image`, `qwen-image` | Text-to-image and reference-image editing; Qwen3-VL-8B encoder and dedicated 2.1 VAE | [models/qwenimage21.md](models/qwenimage21.md) | — |
